      ...
      <Routes>
        ...
        <Route
          ...
          element={
            ...
            !JSON.parse(localStorage.getItem("isOwner")) && <GuestMain />
          }
        />
        <Route
          path="/guest/profile"
          element={
            JSON.parse(localStorage.getItem("isLoggedIn")) &&
            !JSON.parse(localStorage.getItem("isOwner")) && <GuestProfile />
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            JSON.parse(localStorage.getItem("isLoggedIn")) &&
            JSON.parse(localStorage.getItem("isOwner")) && <OwnerMain />
          }
        />
        <Route
